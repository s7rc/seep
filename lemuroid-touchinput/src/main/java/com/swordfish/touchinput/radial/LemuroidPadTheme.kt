...
class LemuroidPadTheme(private val opacity: Float = 1.0f) {
    private fun gray(
        luminosity: Float,
        alpha: Float,
    ): Color {
        return Color(luminosity, luminosity, luminosity, alpha * opacity)
    }
