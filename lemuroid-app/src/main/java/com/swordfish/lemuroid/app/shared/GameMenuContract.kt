...
object GameMenuContract {
    ...
    const val RESULT_ANALOG_DEAD_ZONE_CHANGE = "RESULT_ANALOG_DEAD_ZONE_CHANGE"
    const val RESULT_CHANGE_TILT_CONFIG = "RESULT_CHANGE_TILT_CONFIG"
    const val RESULT_CHANGE_LAYOUT_SETTINGS = 100

    const val EXTRA_CONTROLS_SCALE = "EXTRA_CONTROLS_SCALE"
    const val EXTRA_CONTROLS_OPACITY = "EXTRA_CONTROLS_OPACITY"
    const val EXTRA_CONTROLS_FAST_FORWARD = "EXTRA_CONTROLS_FAST_FORWARD"
    const val EXTRA_CONTROLLER_ID = "EXTRA_CONTROLLER_ID"
    const val EXTRA_SCREEN_ORIENTATION = "EXTRA_SCREEN_ORIENTATION"
}
